      ...
      <View style={styles.cardRow}>
        ...
        >
          <View style={styles.cardHeader}>
            <ThemedText style={[styles.cardTitle, { color: theme.text }]}>Meny & pakker</ThemedText>
        ...
        >
          ...
          <ThemedText style={[styles.cardBody, { color: theme.textSecondary }]}>Send tilbud basert på valgte pakker og gjestetall.</ThemedText>
        ...
        {products.length === 0 ? (
          ...
          products.map((p, idx) => (
            <Animated.View key={p.id} entering={FadeInDown.delay(idx * 30)}>
              <SwipeableRow onDelete={() => handleDeleteProduct(p.id)}>
                <Pressable
                ...
                >
                  <View style={{ flex: 1 }}>
                    ...
                    {p.description ? (
                      <ThemedText numberOfLines={1} style={{ color: theme.textSecondary, fontSize: 12 }}>{p.description}</ThemedText>
                    ) : null}
                  </View>
        ...
        {offers.length === 0 ? (
          ...
          offers.map((o, idx) => (
            <Animated.View key={o.id} entering={FadeInDown.delay(idx * 30)}>
              <SwipeableRow onDelete={() => handleDeleteOffer(o.id)}>
                <Pressable
                  onPress={() => handleEditOffer(o)}
                  style={[styles.listRow, { borderBottomColor: theme.border }]}
                >
                  <View style={{ flex: 1 }}>
