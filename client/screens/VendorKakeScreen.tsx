...
export default function VendorKakeScreen() {
  ...
  return (
    ...
    >
      <ThemedText style={[styles.title, { color: theme.text }]}>Kake dashboard</ThemedText>
      <ThemedText style={[styles.subtitle, { color: theme.textSecondary }]}>Publiser kakepakker, smaker og dekorvalg, og send tilbud raskt.</ThemedText>
